...
const DEFAULT_TEAM_MEMBERS: TeamMember[] = [
  { id: 'tm-1', name: 'Hamza Ansari', role: 'Brand & Content Lead', userRole: 'Admin', email: 'hamzaansari4you@gmail.com', avatarInitials: 'HA', color: '#4f46e5', passcode: '1234' },
  { id: 'tm-2', name: 'Pharmacozyme Ops', role: 'Ops Lead', userRole: 'Manager', email: 'ops@pharmacozyme.com', avatarInitials: 'PO', color: '#0A66C2', passcode: '1234' },
];
