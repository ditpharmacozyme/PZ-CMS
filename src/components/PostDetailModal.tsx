        ...
        <div className="px-3 sm:px-4 py-3 bg-white border-b border-[#bfcab4] flex items-center justify-between sticky top-0 z-10 gap-2">
          ...
          <div className="flex items-center gap-1.5 sm:gap-2 flex-shrink-0">
            <button
              ...
              className="px-2.5 sm:px-3 py-1.5 min-h-[38px] bg-[#efeeea] border border-[#bfcab4] font-label-caps text-[11px] sm:text-xs text-[#1b1c1a] hover:bg-[#296c00] hover:text-white transition-all rounded font-bold flex items-center gap-1.5 cursor-pointer"
