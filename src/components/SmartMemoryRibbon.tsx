...
export const SmartMemoryRibbon: React.FC<SmartMemoryRibbonProps> = ({
  ...
  return (
    <div className="bg-[#1b1c1a] text-white border-b border-[#4f46e5]/40 px-3 py-1.5 sm:px-6 sm:py-2 flex flex-wrap items-center justify-between gap-2 text-xs transition-all shadow-xs z-30">
