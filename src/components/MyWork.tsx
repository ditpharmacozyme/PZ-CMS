    ...
    return (
      <div className="p-4 md:p-8 max-w-4xl mx-auto">
        <div className="bg-white border border-[#e9e9e7] rounded shadow-xs p-8 text-center space-y-2">
          ...
          <p className="font-label-caps text-[10px] text-[#5f5f5b] uppercase font-bold">No teammate identified</p>
    ...
    return (
      ...
      >
        ...
        <div className="flex items-center gap-2 flex-shrink-0">
          ...
          <span className="flex-shrink-0 px-2.5 py-1.5 rounded-lg font-label-caps text-[10px] font-bold uppercase flex items-center gap-1.5 bg-[#f1f1f0] text-[#5f5f5b]">
